...
const Pricing = () => {
  ...
  return (
    ...
    max-md:px-4 min-h-[80vh">
        <div className="text-center mt-16">
          <h2 className="text-gray-100 text-3xl font-medium">Choose Your Plan</h2>
          <p className="text-gray-400 text-sm max-w-md mx-auto mt-2"> Start for Free and Scale up as You Grow. Find the perfect plan
        ...
        <p className="mx-auto text-center text-sm max-w-md mt-10 text-white/60 font-light">Project<span className="text-white"> Creation / Revision</span> consume <span className="text-white">
          5 credits</span>. you can purchase more credits to create more projects.</p>
      </div>
