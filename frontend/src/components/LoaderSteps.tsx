...
const steps = [
  ...
  { icon: SquareIcon, label: 'Genarating layout Structure...' },
  { icon: TriangleIcon, label: 'Assembling UI components...' },
  { icon: CircleIcon, label: 'Finalizaing your website...' },
]
  ...
  return (
    ...
    bg-gray-950 relative overflow-hidden text-white">
      ...
      <div className="realtive z-10 w-32 h-32 flex items-center justify-center">
       ...
       "/>
        <Icon
          className="w-8 h-8 text-white opacity-80 animate-bounce
       "/>
      ...
      <p className="
         text-xs text-gray-400 mt-2 transition-opacity duration-700
         opacity-100">This May Take Around 2-3 minitus...</p>
